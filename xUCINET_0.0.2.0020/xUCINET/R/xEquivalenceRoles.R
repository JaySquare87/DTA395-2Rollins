...
#'
#' @return plot
#' @importFrom blockmodeling plot.mat
#' @export
#' @references
...
#'
#' Takes a rectangular matrix and performs a correspondence analysis on the matrix. This function relies on the CA function in the package FactoMineR.
#'
#' @param MAT1 A rectangular matrix
#'
#' @return A factor map for the CA and the output from the CA function.
#'
...
xCorrespondenceAnalysis<-function(MAT1)
{
  OUTPUT1<-FactoMineR::CA(MAT1)
  OUTPUT1
}
